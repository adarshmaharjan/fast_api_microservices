...
from typing import AbstractSet, Any, Callable, ClassVar, Dict, List, Mapping, Optional, Sequence, Tuple, Type, TypeVar, Union
from typing_extensions import Protocol
from .. import redis
from .._compat import BaseModel, FieldInfo as PydanticFieldInfo, ModelField, ModelMetaclass, NoArgAnyCallable, PYDANTIC_V2, Representation, UndefinedType, validator
...
ERRORS_URL = ...
def get_outer_type(field): # -> type | None:
    ...
...
class FindQuery:
    ...
    @staticmethod
    def resolve_field_type(field: Union[ModelField, PydanticFieldInfo], op: Operators) -> RediSearchFieldTypes:
        ...
    ...
    def resolve_redisearch_pagination(self): # -> list[Any]:
        """Resolve pagination options for a query."""
        ...
    
    def resolve_redisearch_sort_fields(self): # -> list[Any] | None:
    ...
    def execute(self, exhaust_results=..., return_raw_result=..., return_query_args=...): # -> tuple[str | None, Any | List[str | bytes]] | List[RedisModel]:
        ...
    
    def get_query(self): # -> tuple[str | None, Any | List[str | bytes]] | List[RedisModel]:
        ...
    
    def first(self): # -> str | RedisModel | None:
        ...
    
    def count(self): # -> str | RedisModel | None:
        ...
    
    def all(self, batch_size=...): # -> tuple[str | None, Any | List[str | bytes]] | List[RedisModel]:
        ...
    
    def page(self, offset=..., limit=...): # -> tuple[str | None, Any | List[str | bytes]] | List[RedisModel]:
        ...
    
    def sort_by(self, *fields: str): # -> Self | FindQuery:
        ...
    ...
    def __iter__(self): # -> Generator[RedisModel | str | Any | List[str | bytes] | None, Any, None]:
        ...
    
    def __getitem__(self, item: int): # -> RedisModel | str | None:
        """
        Given this code:
            Model.find()[1000]
    ...
    def get_item(self, item: int): # -> RedisModel | str | None:
        """
        Given this code:
...
def Field(default: Any = ..., *, default_factory: Optional[NoArgAnyCallable] = ..., alias: Optional[str] = ..., title: Optional[str] = ..., description: Optional[str] = ..., exclude: Union[AbstractSet[Union[int, str]], Mapping[Union[int, str], Any], Any] = ..., include: Union[AbstractSet[Union[int, str]], Mapping[Union[int, str], Any], Any] = ..., const: Optional[bool] = ..., gt: Optional[float] = ..., ge: Optional[float] = ..., lt: Optional[float] = ..., le: Optional[float] = ..., multiple_of: Optional[float] = ..., min_items: Optional[int] = ..., max_items: Optional[int] = ..., min_length: Optional[int] = ..., max_length: Optional[int] = ..., allow_mutation: bool = ..., regex: Optional[str] = ..., primary_key: bool = ..., sortable: Union[bool, UndefinedType] = ..., case_sensitive: Union[bool, UndefinedType] = ..., index: Union[bool, UndefinedType] = ..., full_text_search: Union[bool, UndefinedType] = ..., vector_options: Optional[VectorFieldOptions] = ..., schema_extra: Optional[Dict[str, Any]] = ...) -> Any:
    ...
...
def outer_type_or_annotation(field): # -> type | type[str]:
    ...
...
class RedisModel(BaseModel, abc.ABC, metaclass=ModelMeta):
    ...
    @classmethod
    def from_redis(cls, res: Any): # -> list[Any]:
        ...
    
    @classmethod
    def get_annotations(cls): # -> dict[Any, Any]:
        ...
...
class HashModel(RedisModel, abc.ABC):
    ...
    @classmethod
    def schema_for_fields(cls): # -> list[Any]:
        ...
